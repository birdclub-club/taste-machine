-- Fix ambiguous column references in Dynamic POA System
-- This fixes the "column reference poa_score is ambiguous" error
...
SELECT 
  ...
  COUNT(*) as returned_nfts,
  AVG(poa_score) as avg_poa_score,
  system_mode as current_mode
