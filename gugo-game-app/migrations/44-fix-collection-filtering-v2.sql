-- 🎛️ Fix Collection Filtering in Enhanced Functions (v2)
-- Drops and recreates all enhanced functions to properly respect active/inactive collection settings
...
-- Recreate enhanced slider function with collection filtering
...
-- Recreate enhanced same collection function with collection filtering
...
-- Recreate enhanced cross collection function with collection filtering
