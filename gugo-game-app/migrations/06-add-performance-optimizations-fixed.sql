-- 🚀 STAGE 6: Performance Optimizations - Matchup Queue System (FIXED)
...
-- Indexes for lightning-fast queue operations (FIXED - removed NOW() from WHERE clauses)
...
DROP TRIGGER IF EXISTS trigger_auto_refill_queue ON public.matchup_queue;
CREATE TRIGGER trigger_auto_refill_queue
